...
const ITEMS = {
  ...
  furn_flag: { id: "furn_flag", name: "兄弟會戰術軍旗", type: "furniture", icon: "🚩", slot: "wall", rarity: "common", factionTag: "none", desc: "防禦+5", effects: { defBonus: 5 } },
  ...
  military_shovel: { id: "military_shovel", name: "舊世軍用軍鏟", type: "weapon", icon: "🥄", stats: { atk: 3 }, rarity: "common", factionTag: "none", desc: "堅固耐用的舊世軍用工兵鏟，敲起東西來格外順手。" },
  ...
  aero_cloak: { id: "aero_cloak", name: "氣流避彈防風衣", type: "armor", icon: "🧥", stats: { def: 1 }, rarity: "rare", factionTag: "aero", desc: "輕薄的防風外套，據說能偏折迎面而來的氣流。" },
  ...
  tesla_battery: { id: "tesla_battery", name: "高壓儲能電容", type: "accessory", icon: "🔋", rarity: "rare", factionTag: "cyber", desc: "握在手裡會微微發麻的高壓電容，還殘留著一點電量。" },
...
// 精神值(SAN)後果(2026-09-25)：動搖/崩潰邊緣時，事件開頭偶爾插入一句幻覺(純氛圍，不改變事件結果)
const SAN_HALLUCINATION_LINES = [
  "眼角餘光裡，牆上的影子似乎慢了半拍才跟上你。",
  "你聽見有人在輕聲喊你的名字，回頭卻什麼也沒有。",
  "耳邊有細碎的低語，像是隔著一層水在說話。",
  "剛才那面牆上的裂縫，好像比記憶中多了一道。",
  "你數了三遍腳步聲，怎麼數都多出一個人的份。",
  "空氣裡飄著一股不屬於這裡的甜味，讓你一陣噁心。",
  "你的手在微微發抖，怎麼握拳都停不下來。",
  "遠處的燈光忽明忽暗，節奏像是某種暗號。",
  "你忽然忘了自己剛才在想什麼，只剩下心口一陣悶。",
  "有那麼一瞬，你覺得整條街都在看著你。",
  "地上的積水映出一個不太像你的輪廓。",
  "背後有人輕輕呼氣。你不敢回頭。",
];
