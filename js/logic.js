...
(function (root) {
  ...
  // 2026-07-03修正：gx/gy相鄰只差1格時，換算成gridPos()的實際像素間距(約23px橫/17px縱)
  // 遠小於格子本體(40x40px)，導致地塊嚴重互相重疊(不是「平行排列」，是疊在一起)。
  // 改成差3格，橫向約70px、縱向約51px，兩者都超過格子尺寸，兩排地塊才會呈現清楚不重疊的平行排列
  ...
  // 2026-07-03修正：理由同FARM_PLOT_LAYOUT，相鄰只差1格會嚴重重疊，改成差3格
  const PEN_LAYOUT = [
    { id: "pen_1", gx: 2, gy: 2 },
    { id: "pen_2", gx: 5, gy: 2 },
    { id: "pen_3", gx: 2, gy: 5 },
